...
// Logout message
$logoutMessage = isset($_GET['message']) && $_GET['message'] == 'logged_out' 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["login"])) { // User login
    ...
    } elseif (isset($_POST["admin_login"])) { // Admin login
    ...
    } elseif (isset($_POST["register"])) { // User registration
        ...
        if ($password !== $password_repeat) {
            ...
            $sql = "INSERT INTO users (full_name, email, password) VALUES ('$fullname', '$email', '$password_hashed')";
